...
export interface PccServer23GroupsGroupUserCreatedDto {
  group?: PccServer23GroupsGroupDto;
}
...
export interface VoloAbpApplicationDtosPagedResultDto1PccServer23GroupsGroupUserCreatedDtoPccServer23ApplicationContractsVersion1000CultureNeutralPublicKeyTokenNull {
  items?: PccServer23GroupsGroupUserCreatedDto[] | null;
  /** @format int64 */
  totalCount?: number;
}
...
> extends HttpClient<SecurityDataType> {
  api = {
    ...
    appCustomGroupsMyCreatedGroupsList: (
      ...
      this.request<
        VoloAbpApplicationDtosPagedResultDto1PccServer23GroupsGroupUserCreatedDtoPccServer23ApplicationContractsVersion1000CultureNeutralPublicKeyTokenNull,
