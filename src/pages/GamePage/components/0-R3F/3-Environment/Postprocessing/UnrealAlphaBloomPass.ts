...
class UnrealAlphaBloomPass extends Pass {
  public nMips = 5;
  ...
  public basic: MeshBasicMaterial;
  public bloomTintColors: Vector3[];
  public materialCopy: ShaderMaterial;
  public compositeMaterial: ShaderMaterial;
  public renderTargetBright: WebGLRenderTarget;
  public materialHighPassFilter: ShaderMaterial;
  public separableBlurMaterials: ShaderMaterial[];
  public copyUniforms: { [uniform: string]: any };
  public renderTargetsVertical: WebGLRenderTarget[];
  public renderTargetsHorizontal: WebGLRenderTarget[];
  public highPassUniforms: { [uniform: string]: any };

  constructor(resolution: Vector2, strength = 1, radius = 0.1, threshold = 0) {
    super();
  ...
  render(
    ...
    for (let i = 0; i < this.nMips; i++) {
      ...
      this.separableBlurMaterials[i].uniforms["direction"].value =
        UnrealAlphaBloomPass.BlurDirectionX;
      ...
      this.separableBlurMaterials[i].uniforms["direction"].value =
        UnrealAlphaBloomPass.BlurDirectionY;
...
UnrealAlphaBloomPass.BlurDirectionX = new Vector2(1.0, 0.0);
UnrealAlphaBloomPass.BlurDirectionY = new Vector2(0.0, 1.0);
export { UnrealAlphaBloomPass };
