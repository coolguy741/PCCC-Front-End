...
const kitchenMaterial = new MeshPhysicalMaterial();

const kitchenMaterialOBC = (shader: Shader) => {
  ...
  kitchenMaterial.userData.shader = shader;
};

const kitchenColorMultiplier = new Vector3();

export { kitchenMaterial, kitchenMaterialOBC, kitchenColorMultiplier };
