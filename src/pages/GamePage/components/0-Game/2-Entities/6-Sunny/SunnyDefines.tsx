...
const handleOBCAlpha = (shader: Shader) => {
...
const SunnyMaterial = new MeshPhysicalMaterial({ transparent: true });

SunnyMaterial.onBeforeCompile = handleOBCAlpha;

export { SunnyMaterial, handleOBCAlpha };
